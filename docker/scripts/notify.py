...
def main():
    ...
    events = {
        ...
        "plan.complete": (
            "Mekong CLI — Plan Ready",
            "PEV plan phase completed. Review the plan.",
            "info",
        ),
        "execute.complete": (
            "Mekong CLI — Execution Done",
            "All steps executed. Verifying results...",
            "info",
        ),
        "verify.pass": ("Mekong CLI — Verified", "All quality gates passed.", "success"),
        "verify.fail": (
            "Mekong CLI — Verification Failed",
            "Quality gates failed. Check the output.",
            "failure",
        ),
        "cook.done": (
            "Mekong CLI — Mission Complete",
            "Full PEV pipeline finished successfully.",
            "success",
        ),
    }
