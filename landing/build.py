...
PRICING_TIERS = [
    {
        ...
        "price_usd": 49,
        "credits": 200,
        "price_id": "polar_cl_apvIt00Pf7vw2GGX0PW7tWfNjSiwaTRUl0YzO3YqVhA",
    },
    {
        "name": "Growth",
        "price_usd": 149,
        "credits": 1000,
        "price_id": "polar_cl_TDhelBvQfsZq3Rayqf9to4tl0UD6D04OBFqXm1zJDVC",
    },
    {
        "name": "Pro",
        "price_usd": 499,
        "credits": 5000,
        "price_id": "polar_cl_zi7LHdaPk93V0xbNVQZgqum96gWCFDTVzpDNR2kfN3j",
    },
]
...
def build():
    ...
    for tenant in tenants:
        ...
        tiers = [
            {**t, "checkout_url": f"{POLAR_BASE}/{t['price_id']}/redirect"} for t in PRICING_TIERS
        ]
...
"""
    ...
    for t in tenants:
        sitemap_entries.append(
            f'  <url><loc>https://www.mekongmind.com/{t["slug"]}/</loc><priority>0.8</priority></url>'
        )
    sitemap_entries.append(
        "  <url><loc>https://www.mekongmind.com/guide/</loc><priority>0.9</priority></url>"
    )
