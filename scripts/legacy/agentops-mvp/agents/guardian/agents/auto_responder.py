...
class AutoResponder(GuardianBase):
    ...
    def __init__(self):
        ...
        self.response_templates = {
            "walk_away": {"subject": "RE: Term Sheet - Unable to Proceed", "tone": "firm"},
            "negotiate": {"subject": "RE: Term Sheet - Counter-Proposal", "tone": "professional"},
            "proceed": {
    ...
    def _generate_email_body(
        self, response_type: str, red_flags: Dict, counter_offers: Dict, risk_score: Dict
    ) -> str:
...
[Founder Name]"""
    ...
    def personalize_response(
        self, response: Dict, company_name: str, investor_name: str, founder_name: str
    ) -> Dict:
    ...
    def generate_follow_up_schedule(self, response_type: str) -> Dict[str, Any]:
        ...
        schedules = {
            ...
            "proceed": {"follow_up_in_days": 2, "message": "Confirming next steps for closing"},
        }
