...
class GuardianAgent:
    ...
    def review_term_sheet(self, document_text: str, stage: str = "Seed") -> Dict[str, Any]:
        ...
        counter_offers = self.advisor.generate_counter_offers(terms, red_flags.get("red_flags", []))
        ...
        response = self.responder.draft_response(terms, red_flags, counter_offers, risk_assessment)
