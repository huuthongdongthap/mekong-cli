...
HYDRATIONS: dict[str, dict] = {
    ...
    "swot": {
        "display": {
            "description_en": "SWOT analysis — strengths, weaknesses, opportunities, threats"
        },
        "execution": {
        ...
        "input": {
            ...
            "properties": {
                ...
                "focus": {
                    "type": "string",
                    "enum": ["product", "market", "team", "financial"],
                    "description": "Analysis focus area",
                },
                "competitors": {
                    "type": "array",
                    "items": {"type": "string"},
                    "description": "Known competitors to compare",
                },
            },
        },
        "output": {
        ...
        "validation": {
            "output_must_contain": ["strengths", "weaknesses"],
            "min_output_length": 200,
        },
    },
    "plan": {
        "display": {
            "description_en": "Create implementation plan with phases, dependencies, and estimates"
        },
        "execution": {
    ...
    "test": {
        "display": {
            "description_en": "Run test suite with coverage analysis and failure diagnosis"
        },
        "execution": {
            "agents": ["tester"],
            "hub": "engineering-hub",
    ...
    "deploy": {
        "display": {
            "description_en": "Deploy to production — build, push, verify CI/CD, confirm green"
        },
        "execution": {
            "agents": ["devops"],
            "hub": "engineering-hub",
    ...
    "audit": {
        "display": {
            "description_en": "Security and code quality audit — deps, secrets, OWASP checks"
        },
        "execution": {
        ...
        "input": {
            ...
            "properties": {
                ...
                "audit_type": {
                    "type": "string",
                    "enum": ["security", "code", "dependency", "full"],
                },
                "severity_threshold": {
                    "type": "string",
    ...
    "annual": {
        "display": {
            "description_en": "Annual business plan — vision, goals, financials, milestones"
        },
        ...
        "output": {
            ...
            "properties": {
                ...
                "milestones": {
                    ...
                    "items": {
                        "type": "object",
                        "properties": {"quarter": {"type": "string"}, "target": {"type": "string"}},
                    },
                },
            },
        },
    ...
    "pricing": {
        "display": {
            "description_en": "Pricing strategy — competitive analysis, tier design, revenue modeling"
        },
        "execution": {
    ...
    "marketing": {
        ...
        "input": {
            ...
            "properties": {
                ...
                "channel": {
                    "type": "string",
                    "enum": ["seo", "social", "email", "ads", "content", "all"],
                },
                "budget": {"type": "number"},
            },
        },
    ...
    "sales": {
        ...
        "output": {
            ...
            "properties": {
                ...
                "outreach_templates": {"type": "array", "items": {"type": "string"}},
            },
        },
        "cascade": {"triggers": []},
    },
    ...
    "sprint": {
        "display": {
            "description_en": "Sprint planning — backlog grooming, task breakdown, assignments"
        },
    ...
    "fix": {
        ...
        "input": {
            ...
            "required": ["goal"],
            "properties": {
                "goal": {"type": "string", "description": "Bug description or error message"},
                "logs": {"type": "string"},
        ...
        "validation": {
            "output_must_contain": ["root_cause", "fix_description"],
    ...
    "health": {
        ...
        "output": {
            "type": "object",
            "properties": {
                "overall_status": {"type": "string", "enum": ["healthy", "degraded", "down"]},
                "services": {
                    "type": "array",
                    "items": {
                        "type": "object",
    ...
    "status": {
        ...
        "input": {
            "type": "object",
            "required": ["goal"],
            "properties": {"goal": {"type": "string"}, "project": {"type": "string"}},
        },
        "output": {
            "type": "object",
            "properties": {
    ...
    "debug": {
        "display": {
            "description_en": "Systematic debugging with log analysis and root cause identification"
        },
        ...
        "input": {
            ...
            "required": ["goal"],
            "properties": {
                "goal": {"type": "string", "description": "Error or symptom description"},
                "logs": {"type": "string"},
    ...
    "security": {
        ...
        "input": {
            ...
            "properties": {
                "goal": {"type": "string"},
                "scan_type": {"type": "string", "enum": ["dependency", "code", "config", "full"]},
            },
        },
        "output": {
            "type": "object",
    ...
    "content": {
        "display": {
            "description_en": "Content creation — blog posts, social media, email sequences"
        },
        ...
        "input": {
            ...
            "properties": {
                ...
                "content_type": {
                    "type": "string",
                    "enum": ["blog", "social", "email", "docs", "newsletter"],
                },
    ...
    "competitive": {
        "display": {
            "description_en": "Competitive analysis — market positioning, feature comparison, battlecards"
        },
        "execution": {
    ...
    "research": {
        "display": {
            "description_en": "Technical research — architecture evaluation, best practices, trade-offs"
        },
    ...
    "milestone": {
        ...
        "input": {
            "type": "object",
            "required": ["goal"],
            "properties": {"goal": {"type": "string"}, "milestone_name": {"type": "string"}},
        },
        "output": {
            "type": "object",
            "properties": {
    ...
    "outreach": {
        ...
        "input": {
            ...
            "properties": {
                "goal": {"type": "string"},
                "channel": {"type": "string", "enum": ["email", "linkedin", "twitter", "phone"]},
        ...
        "output": {
            ...
            "properties": {
                ...
                "targets_contacted": {"type": "integer"},
                "follow_up_schedule": {"type": "array", "items": {"type": "string"}},
            },
        },
        "cascade": {"triggers": []},
    },
    "scout": {
        "display": {
            "description_en": "Codebase scouting — file discovery, task context, architecture analysis"
        },
        "execution": {
            "agents": ["researcher"],
            "hub": "ops-hub",
        ...
        "input": {
            ...
            "properties": {
                "goal": {"type": "string"},
                "scope": {"type": "string", "enum": ["file", "module", "full"]},
                "pattern": {"type": "string"},
            },
        },
        "output": {
