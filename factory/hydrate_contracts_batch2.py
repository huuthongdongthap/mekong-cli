...
HYDRATIONS: dict[str, dict] = {
    ...
    "fundraise": {
        "display": {
            "description_en": "Fundraise preparation — pitch deck, financial model, investor targeting"
        },
        "execution": {
        ...
        "input": {
            ...
            "properties": {
                "goal": {"type": "string"},
                "round": {"type": "string", "enum": ["pre-seed", "seed", "series-a", "series-b"]},
        ...
        "output": {
            "type": "object",
            "properties": {
                "pitch_deck_path": {"type": "string"},
                "financial_model": {"type": "object"},
                "investor_list": {
                    "type": "array",
                    "items": {
                        "type": "object",
                        "properties": {"name": {"type": "string"}, "fit_score": {"type": "number"}},
                    },
                },
                "valuation_range": {
                    "type": "object",
    ...
    "pitch": {
        ...
        "input": {
            ...
            "properties": {
                "goal": {"type": "string"},
                "audience": {"type": "string", "enum": ["investors", "customers", "partners"]},
    ...
    "refactor": {
        "display": {
            "description_en": "Refactor code — improve structure without changing behavior"
        },
        "execution": {
        ...
        "cascade": {
            "triggers": [{"pattern": ".*", "suggest": "test", "target_layer": "engineering"}]
        },
    },
    "migrate": {
        ...
        "input": {
            ...
            "properties": {
                "goal": {"type": "string"},
                "database": {"type": "string", "enum": ["d1", "postgres", "supabase"]},
    ...
    "hr": {
        ...
        "input": {
            ...
            "properties": {
                "goal": {"type": "string"},
                "action": {"type": "string", "enum": ["hire", "onboard", "review", "offboard"]},
            },
        },
        "output": {
            "type": "object",
    ...
    "budget": {
        "display": {
            "description_en": "Budget planning — allocation, forecasting, variance analysis"
        },
    ...
    "brand": {
        ...
        "input": {
            ...
            "properties": {
                "goal": {"type": "string"},
                "brand_type": {"type": "string", "enum": ["personal", "corporate", "product"]},
            },
        },
        "output": {
            "type": "object",
    ...
    "scope": {
        "display": {
            "description_en": "Scope definition — boundaries, requirements, acceptance criteria"
        },
        ...
        "input": {
            ...
            "properties": {
                "goal": {"type": "string"},
                "scope_type": {"type": "string", "enum": ["feature", "sprint", "project"]},
            },
        },
        "output": {
            "type": "object",
    ...
    "backlog": {
        ...
        "input": {
            ...
            "properties": {
                "goal": {"type": "string"},
                "action": {"type": "string", "enum": ["groom", "prioritize", "estimate"]},
            },
        },
        "output": {
            "type": "object",
    ...
    "clean": {
        ...
        "input": {
            ...
            "properties": {
                ...
                "targets": {
                    "type": "array",
                    "items": {"type": "string", "enum": ["build", "cache", "deps", "all"]},
                },
            },
        },
        "output": {
            ...
            "properties": {
                ...
                "paths_cleaned": {"type": "array", "items": {"type": "string"}},
            },
        },
    },
    # ═══ WRITER / CONTENT ═══
    "seo": {
        "display": {
            "description_en": "SEO analysis — keywords, rankings, optimization recommendations"
        },
    ...
    "email": {
        "display": {
            "description_en": "Email sequences — drip campaigns, newsletters, transactional"
        },
        ...
        "input": {
            ...
            "properties": {
                ...
                "email_type": {
                    "type": "string",
                    "enum": ["drip", "newsletter", "transactional", "cold"],
                },
    ...
    "crm": {
        ...
        "input": {
            ...
            "properties": {
                ...
                "action": {
                    "type": "string",
                    "enum": ["add-contact", "update-deal", "pipeline-report", "segment"],
                },
            },
        },
        "output": {
    ...
    "git-status": {
        ...
        "input": {
            "type": "object",
            "required": ["goal"],
            "properties": {"goal": {"type": "string"}, "repo": {"type": "string"}},
        },
        "output": {
            "type": "object",
            "properties": {
    ...
    "git-pr": {
        ...
        "input": {
            ...
            "properties": {
                "goal": {"type": "string"},
                "action": {"type": "string", "enum": ["create", "review", "merge", "close"]},
                "branch": {"type": "string"},
            },
        },
        "output": {
    ...
    "docs-init": {
        ...
        "input": {
            "type": "object",
            "required": ["goal"],
            "properties": {"goal": {"type": "string"}, "project_type": {"type": "string"}},
        },
        "output": {
            "type": "object",
            "properties": {
    ...
    "docs-update": {
        ...
        "input": {
            ...
            "properties": {
                "goal": {"type": "string"},
                "scope": {"type": "string", "enum": ["api", "readme", "architecture", "all"]},
            },
        },
        "output": {
            "type": "object",
    ...
    "analytics": {
        ...
        "input": {
            ...
            "properties": {
                ...
                "metric_type": {
                    "type": "string",
                    "enum": ["revenue", "usage", "engagement", "performance"],
                },
                "period": {"type": "string"},
            },
        },
    ...
    "tam": {
        "display": {
            "description_en": "Total Addressable Market analysis — market sizing and segmentation"
        },
        "execution": {
    ...
    "positioning": {
        "display": {
            "description_en": "Market positioning — differentiation, value proposition, messaging"
        },
        ...
        "output": {
            ...
            "properties": {
                ...
                "differentiation_map": {"type": "object"},
            },
        },
    },
    "market": {
        "display": {
            "description_en": "Market analysis — trends, opportunities, competitive landscape"
        },
        "execution": {
            "agents": ["researcher", "strategist"],
            "hub": "business-hub",
    ...
    "benchmark": {
        "display": {
            "description_en": "Performance benchmark — latency, throughput, resource usage"
        },
    ...
    "incident": {
        ...
        "execution": {
            "agents": ["devops", "fullstack-developer"],
            "hub": "ops-hub",
            "credit_cost": 3,
            "requires_approval": True,
        },
