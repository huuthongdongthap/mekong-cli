...
def build_app() -> typer.Typer:
    ...
    from src.cli.codex_registry_command import register_codex_registry_command
    from src.cli.goals_command import register_goals_command
    from src.cli.mekong_cli_command import register_mekong_cli_command
    ...
    root.add_typer(config_app, name="config", help="Manage environment and command configuration")
    ...
    register_codex_registry_command(root)
    register_goals_command(root)
    register_mekong_cli_command(root)
    ...
    # Register all legacy and business-level command groups (doctor, lint, security, etc.)
    from src.cli.command_registry_legacy import register_legacy_commands

    register_legacy_commands(root)
