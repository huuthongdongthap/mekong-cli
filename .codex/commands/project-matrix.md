---
codex-command: "/project-matrix"
source: ".claude/commands/project-matrix.md"
invocation: "mekong project-matrix $ARGUMENTS"
description: "Show project priority matrix — ranked by business impact (ROI + maturity + activity)"
argument-hint: "[--top=5 | --all]"
allowed-tools: "Bash"
content-sha256: "0ffdaccfd64a5c80c3d37b1ccd326753fbcedab4cd6769c210d8042286e49fe7"
---
...
```bash
mekong project-matrix $ARGUMENTS
```
