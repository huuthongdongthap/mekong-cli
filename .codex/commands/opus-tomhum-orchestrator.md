---
codex-command: "/opus-tomhum-orchestrator"
source: ".claude/commands/opus-tomhum-orchestrator.md"
invocation: "mekong opus-tomhum-orchestrator $ARGUMENTS"
...
content-sha256: "f9a3389a854085016fd683b8e95ca9b5cdef1659dff01db859534c1d926219b2"
---

# /opus-tomhum-orchestrator

Run this Mekong command through the project CLI from `/Users/mac/mekong-cli`.

```bash
mekong opus-tomhum-orchestrator $ARGUMENTS
```
