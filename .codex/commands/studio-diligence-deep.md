---
codex-command: "/studio-diligence-deep"
source: ".claude/commands/studio-diligence-deep.md"
invocation: "mekong studio-diligence-deep $ARGUMENTS"
...
content-sha256: "25e7058fb9bfec580503c0eda788847d88ff7904dd6dc537ec1dd0b03ddfac3e"
---

# /studio-diligence-deep

Run this Mekong command through the project CLI from `/Users/mac/mekong-cli`.

```bash
mekong studio-diligence-deep $ARGUMENTS
```
