---
codex-command: "/factory-restart"
source: ".claude/commands/factory-restart.md"
invocation: "mekong factory-restart $ARGUMENTS"
description: "Safely restart factory loop without killing active CC CLI tasks"
argument-hint: "[--force | --status]"
allowed-tools: "Bash"
content-sha256: "3f4a22f2e47143a6f247674a1d846f040151314818095db73e6c67bf71cb980e"
---
...
```bash
mekong factory-restart $ARGUMENTS
```
