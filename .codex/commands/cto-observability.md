---
codex-command: "/cto-observability"
source: ".claude/commands/cto-observability.md"
invocation: "mekong cto-observability $ARGUMENTS"
description: "Full CTO observability dashboard — telemetry, anomalies, dispatch health"
argument-hint: "[--anomalies | --telemetry | --all]"
allowed-tools: "Bash"
content-sha256: "41ed9cceae3c01163d2d0968ee1c4cc58a0ff87579dcab6928d10fc6d1a0b344"
---
...
```bash
mekong cto-observability $ARGUMENTS
```
