---
codex-command: "/production-status"
source: ".claude/commands/production-status.md"
invocation: "mekong production-status $ARGUMENTS"
...
allowed-tools: "Bash"
content-sha256: "486efd0c26e19cbeb1baba2c3270859c4539393e5c56279d8a0da510fd19a8a4"
---
...
```bash
mekong production-status $ARGUMENTS
```
