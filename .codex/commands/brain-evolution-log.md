---
codex-command: "/brain-evolution-log"
source: ".claude/commands/brain-evolution-log.md"
invocation: "mekong brain-evolution-log $ARGUMENTS"
description: "Show CTO brain evolution history — what it learned over time, strategy changes"
argument-hint: "[--last=10 | --all]"
allowed-tools: "Bash"
content-sha256: "aec7ac3edfe6de6e8e7452ae448caf77b5cd35dbe33f9315c26b5e360ffe1206"
---
...
```bash
mekong brain-evolution-log $ARGUMENTS
```
