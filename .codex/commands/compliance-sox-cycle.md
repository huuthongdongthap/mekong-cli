---
codex-command: "/compliance-sox-cycle"
source: ".claude/commands/compliance-sox-cycle.md"
invocation: "mekong compliance-sox-cycle $ARGUMENTS"
description: "Full SOX cycle — SOX testing, ITGC, risk assessment, risk report"
argument-hint: "[goal]"
allowed-tools: "Read, Write, Bash, Task"
content-sha256: "d4f72e1af4abb744fdf0ad70790151845527118bd50500aa5790213271130f0d"
---

# /compliance-sox-cycle

Run this Mekong command through the project CLI from `/Users/mac/mekong-cli`.

```bash
mekong compliance-sox-cycle $ARGUMENTS
```
