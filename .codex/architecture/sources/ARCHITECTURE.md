...
│   ├── subagents/              # 6 primary task-based subagents
│   │   └── primary/            # planner, fullstack, debugger, designer, scout, copywriter
│   ├── workflows/              # 27 extended agentic workflows
│   ├── skills/                 # 5 skill categories (AI, backend, frontend, tools, integrations)
│   └── crews/                  # 6 multi-agent crews (revenue, growth, ops, quality, intel, support)
│
...
| --------- | ------ | ------------ | ----- |
| Commands  | 505    | 504 (TOML)   | 505   |
| Agents    | 22     | 6            | 28    |
| Skills    | 39     | 5 categories | 44+   |
| Workflows | 24     | 49           | 73    |
| Crews     | —      | 6            | 6     |
| Products  | —      | —            | 15    |
