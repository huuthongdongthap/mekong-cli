...
class TestLoginEndpoint:
    ...
    def test_inactive_license_returns_402(self, client, _isolate_license_store):
    ...
    def test_missing_tenant_id_returns_500(self, client, _isolate_license_store):
    ...
    def test_token_iat_recent(self, client, _isolate_license_store, jwt_secret):
        ...
        after = int(time.time())
        assert resp.status_code == 200
        claims = jwt.decode(resp.json()["access_token"], jwt_secret, algorithms=[JWT_ALGORITHM])
