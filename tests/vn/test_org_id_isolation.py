...
def _signup(
    client: TestClient, zalo: str, name: str = "User", org_id: str | None = None
) -> dict[str, Any]:
...
class TestOrgSignup:
    ...
    def test_invalid_org_id_rejected(self, client: TestClient, bad_org: str) -> None:
        ...
        ), f"Expected 422 for org_id={bad_org!r}, got {resp.status_code}"
...
class TestOrgRecent:
    ...
    def test_recent_legacy_records_in_default(self, client: TestClient, tmp_path: Path) -> None:
