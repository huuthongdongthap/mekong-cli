...
class TestMISAExporter:
    ...
    def test_env_override_swaps_codes(self, monkeypatch: pytest.MonkeyPatch) -> None:
...
class TestMISARoute:
    ...
    def test_route_returns_csv_content_type(self, client: TestClient, tmp_path: Path) -> None:
        _write_conversions(
            tmp_path,
            [
    ...
    def test_route_empty_range_returns_header_only(self, client: TestClient) -> None:
    ...
    def test_route_includes_conversions_in_range(self, client: TestClient, tmp_path: Path) -> None:
        _write_conversions(
            tmp_path,
            [
