...
class TestIdempotency:
    ...
    def test_duplicate_tx_ref_returns_already_processed(self, client: TestClient) -> None:
        user_id = _seed_pilot(client)
        payload = {
            "tx_ref": "TX_DUP_001",
            "amount": 199_000,
...
class TestMemoParser:
    ...
    def test_unparseable_memo_returns_200_logged(self, client: TestClient) -> None:
    ...
    def test_memo_legacy_format_routes_to_default_org(self, client: TestClient) -> None:
    ...
    def test_memo_org_prefix_acme_routes_correctly(self, client: TestClient) -> None:
    ...
    def test_memo_parse_failure_returns_200_not_5xx(self, client: TestClient) -> None:
...
class TestTierMatching:
    ...
    def test_valid_tier_amounts(self, client: TestClient, amount: int, expected_tier: str) -> None:
        user_id = _seed_pilot(client)
        resp = _post_webhook(
            client,
            {
    ...
    def test_unrecognized_amount_returns_logged_200(self, client: TestClient) -> None:
        user_id = _seed_pilot(client)
        resp = _post_webhook(
            client,
            {
...
class TestWebhookLog:
    ...
    def test_log_records_all_outcomes(self, client: TestClient, tmp_path: Path) -> None:
