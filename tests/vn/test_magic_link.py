...
def test_mint_inserts_row(tmp_path: Path) -> None:
    ...
    row = conn.execute("SELECT * FROM magic_link_tokens WHERE token = ?", (token,)).fetchone()
    conn.close()
...
# =============================================================================
def test_magic_link_endpoint_returns_200(client: TestClient, mock_resend: list[dict]) -> None:
...
# =============================================================================
def test_rate_limit_drops_silently(client: TestClient, mock_resend: list[dict]) -> None:
...
# =============================================================================
def test_enumeration_resistance(client: TestClient, mock_resend: list[dict]) -> None:
...
# =============================================================================
def test_rate_limit_boundary(client: TestClient, mock_resend: list[dict]) -> None:
