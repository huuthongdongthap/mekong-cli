...
class TestSignup:
    ...
    @pytest.mark.parametrize(
        "valid_zalo", ["+84909123456", "0909123456", "+84 909 123 456", "+849091234567"]
    )
...
class TestStatsConversionCrossref:
    ...
    def _write_conversion(
        ...
        monthly: int = 199_000,
        started_at: str = "2026-05-17",
    ) -> None:
        vpr._append_jsonl(
            vpr._conversions_path(),
            {
                "user_id": user_id,
                "tier": tier,
                "monthly_vnd": monthly,
...
class TestFounderSignupWebhook:
    ...
    def test_notifier_swallows_internal_errors(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_notifier_no_url_returns_silently(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_notifier_with_url_invokes_httpx(self, monkeypatch: pytest.MonkeyPatch) -> None:
