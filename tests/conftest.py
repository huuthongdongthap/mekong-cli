...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "redis: marks tests as requiring Redis connection")
    config.addinivalue_line(
        "markers", "integration: marks integration tests (slower, external deps)"
    )
...
def pytest_addoption(parser):
    ...
    parser.addoption(
        "--integration", action="store_true", default=False, help="Run integration tests (slower)"
    )
