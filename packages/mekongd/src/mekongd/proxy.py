...
async def signals_breakdown(hours: int | None = None, source: str | None = None):
    ...
    return {"by_model": aggregate_signals_by_model(cfg.stats_db_path, hours, source=effective)}
