...
def test_doctor_no_urls_skips_mekongd_pings_forest(tmp_path, monkeypatch, capsys):
    ...
    cli.doctor_cmd(mekongd_url=None, forest_url="http://127.0.0.1:1", timeout=0.2, as_json=False)
...
def test_doctor_json_emits_parseable_payload(tmp_path, monkeypatch, capsys):
    ...
    cli.doctor_cmd(mekongd_url=None, forest_url="http://127.0.0.1:1", timeout=0.2, as_json=True)
