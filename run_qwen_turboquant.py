...
try:
    ...
    print(f"Lỗi import: {e}. Vui lòng đảm bảo đã chạy pip install -r requirements.txt trong turboquant-mlx")
    sys.exit(1)
...
def main():
    ...
    messages = [
        {"role": "user", "content": "Viết một hàm Python tính số Fibonacci thứ N tối ưu nhất. Nhớ suy luận từng bước một."}
    ]
